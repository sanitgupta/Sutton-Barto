            ...
            for j in range(mc + 1):
                ...
                for k1 in range(m):
                    for k2 in range(m):
                        for k3 in range(m):
                            for k4 in range(m):
                                r = 10 * min(k1, i) + 10 * min(k2, j) - 2 * abs(pi[i, j])
                                tempi = int(max(min(k3 + i - min(k1, i) - pi[i, j], 20), 0))
                                tempj = int(max(min(k4 + j - min(k2, j) + pi[i, j], 20), 0))
            ...
            for b in range(-5, 6):
                for k1 in range(m):
                    for k2 in range(m):
                        for k3 in range(m):
                            for k4 in range(m):
                                r = 10 * min(k1, i) + 10 * min(k2, j) - 2 * abs(b)
                                tempi = int(max(min(k3 + i - min(k1, i) - b, 20), 0))
                                tempj = int(max(min(k4 + j - min(k2, j) + b, 20), 0))
